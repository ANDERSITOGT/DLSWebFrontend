...
export default function SolicitudesPage() {
  ...
  const handleClickSolicitud = async (sol: SolicitudResumen) => {
    ...
    // 1. Seteamos un estado base temporal para que el modal abra rápido con info parcial
  ...
  // Función auxiliar para exportar PDF (opcional si lo agregaste al backend)
    ...
    <div className="space-y-6">
      ...
      <header className="mb-2 flex items-center justify-between gap-3">
        ...
        <button
          ...
          onClick={() => alert("Funcionalidad de Crear próximamente")}
        >
          + Nueva Acción
        </button>
      </header>
                    ...
                    >
                      ...
                      <div className="flex-1 space-y-0.5">
                        ...
                        <p className="text-[10px] text-slate-500">
                          Código: {prod.codigo}
                          {prod.loteCodigo && ` • Lote: ${prod.loteCodigo}`}
                        </p>
                        {prod.notas && (
